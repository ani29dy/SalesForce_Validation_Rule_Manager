...
export const getLoginUrl = () =>
  API_URL ? `${API_URL}/auth/login` : "/auth/login";
export const getLogoutAllUrl = () =>
  API_URL ? `${API_URL}/auth/logout-all` : "/auth/logout-all";

// Validation Rules
export const fetchValidationRules = () => api.get("/validation-rules");
export const getCachedValidationRules = () =>
  api.get("/validation-rules/cached");
